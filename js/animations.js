...
var startPath2 = "M-10 250 C 0 250, 600 250, 300 250 S 1 250, " + winWidth + " 250";
...
function animateWave(waveNum, width, miliSec) {
  ...
  if (waveNum == wave2 ) {
    var Path1 = "M-10 275 C 0 275, 150 175, 400 175 S 600 250, " + length + " 275";
    var Path2 = "M-10 300 C 0 300, 350 200, 700 175 S 1100 300, " + length + " 275";
    var Path3 = "M-10 275 C 0 275, 550 225, 900 175 S 1200 175, " + length + " 300";
    var Path4 = "M-10 275 C 0 275, 750 250, 1200 175 S 1400 175, " + length + " 275";
    var Path5 = "M-10 275 C 0 275, 1150 300, 1400 300 S 1600 300, " + lengthEnd + " 300";
  };
